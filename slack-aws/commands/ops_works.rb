        ...
        when 'instance' then
          ...
          case instance_cmd
            ...
            when 'help' then
              ...
              send_message client, data.channel, "additional recipes: `ucc <name>`, `upgrade <name> <api_branch|default:live> <client_branch|default:live>`, `clonedb <name> <from_stack>:<from_instance>`, `backupdb <name>`, `restoredb <name> <sql_file>`, `emptydb <name>`, `grantdb <name>`"
              send_message client, data.channel, "current stack: *#{@@current_stack}*" 
